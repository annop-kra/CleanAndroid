...
import com.ankn.cleanandroidtemplate.databinding.ItemLoadStateBinding

class CommentsLoadStateAdapter (
    private val retry: () -> Unit
) : LoadStateAdapter<CommentsLoadStateAdapter.LoadStateViewHolder>() {
